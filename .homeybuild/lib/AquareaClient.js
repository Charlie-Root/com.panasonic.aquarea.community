...
class AquareaClient {
  ...
  async getDeviceData(deviceId) {
    ...
    return {
      ...
      tankTemperature: tank ? this._num(tank.temperatureNow) : null,
      tankTargetTemperature: tank ? this._num(tank.heatSet) : null,
      ...
      zoneTemperature: this._num(zone.temperatureNow),
      zoneHeatSet: this._num(zone.heatSet),
      zoneHeatMin,
      zoneHeatMax,
      zoneIsCurveOffset,
      ...
      // --- Systeme ---
      outdoorTemperature: this._num(status.outdoorNow),
